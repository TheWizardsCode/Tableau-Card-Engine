...
export class GymHandPileScene extends GymSceneBase {
  ...
  // Selection-raise slider bounds — raise is off (0px) until adjusted
  private readonly RAISE_DEFAULT = 0;
  private readonly RAISE_MAX = 60;
