...
describe('SushiGoConstants', () => {
  ...
  describe('chopsticks button constants', () => {
    ...
    it('CHOPSTICKS_BUTTON_PADDING_X is 12', () => {
      expect(CHOPSTICKS_BUTTON_PADDING_X).toBe(12);
    });
    it('CHOPSTICKS_BUTTON_PADDING_Y is 6', () => {
      expect(CHOPSTICKS_BUTTON_PADDING_Y).toBe(6);
    });
  });
