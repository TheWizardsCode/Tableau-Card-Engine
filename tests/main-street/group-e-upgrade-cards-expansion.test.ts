...
const NEW_UPGRADE_CONTRACTS: NewUpgradeContract[] = [
  { id: 'upg-smoothie-bar', name: 'Upgrade to Smoothie Bar', target: 'Juice Bar', cost: 4, incomeBonus: 1, synergyRangeBonus: 0, requiredLevel: 0, tier: '2' },
  { id: 'upg-wellness-retreat', name: 'Upgrade to Wellness Retreat', target: 'Yoga Studio', cost: 5, incomeBonus: 1.5, synergyRangeBonus: 1, requiredLevel: 0, tier: '3' },
  { id: 'upg-fitness-center', name: 'Upgrade to Fitness Center', target: 'Gym', cost: 5, incomeBonus: 1.5, synergyRangeBonus: 1, requiredLevel: 0, tier: '3' },
  { id: 'upg-dental-clinic', name: 'Upgrade to Dental Clinic', target: 'Dentist', cost: 7, incomeBonus: 2, synergyRangeBonus: 1, requiredLevel: 0, tier: '4' },
  ...
  { id: 'upg-toy-warehouse', name: 'Upgrade to Toy Warehouse', target: 'Toy Store', cost: 4, incomeBonus: 1, synergyRangeBonus: 1, requiredLevel: 0, tier: '2' },
  ...
  { id: 'upg-adventure-park', name: 'Upgrade to Adventure Park', target: 'Playground', cost: 3, incomeBonus: 0, synergyRangeBonus: 0, requiredLevel: 0, tier: '1', reputationBonus: 0.05 },
  ...
  { id: 'upg-grand-fountain', name: 'Upgrade to Grand Fountain', target: 'Town Fountain', cost: 3, incomeBonus: 0, synergyRangeBonus: 0, requiredLevel: 0, tier: '2', reputationBonus: 0.05 },
  { id: 'upg-health-center', name: 'Upgrade to Health Center', target: 'Health Kiosk', cost: 4, incomeBonus: 0, synergyRangeBonus: 0, requiredLevel: 0, tier: '3', reputationBonus: 0.05 },
];
