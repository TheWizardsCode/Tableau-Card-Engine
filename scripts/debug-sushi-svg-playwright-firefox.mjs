...
(async () => {
  ...
  try {
    ...
    if (!canvas) {
      ...
      await canvas.screenshot({ path: 'artifacts/sushi-go-scene-firefox.png' });
      console.log('Saved screenshot to artifacts/sushi-go-scene-firefox.png');
    }

    // Save console logs
    fs.mkdirSync('artifacts', { recursive: true });
    fs.writeFileSync('artifacts/sushi-go-console-firefox.json', JSON.stringify(logs, null, 2));
    console.log('Saved browser console logs to artifacts/sushi-go-console-firefox.json');
